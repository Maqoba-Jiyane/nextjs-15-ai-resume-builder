  ...
  const handlePrint = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        a.href = url;
        a.download = `${resume.firstName}_${resume.lastName}${resume.title && "_" + resume.title.replaceAll(" ", "_")}${resume.description && "_" + resume.description.substring(0, 40).replaceAll(" ", "_")}.png`;
        a.click();
