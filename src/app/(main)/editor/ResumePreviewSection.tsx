...
const ResumePreviewSection = ({
  ...
  return (
    ...
    >
      <div className="opacity-50 z-40 2xl:opacity-100 group-hover:opacity-100 transition-opacity absolute left-1 top-1 flex flex-col gap-3 flex-none lg:left-3 lg:top-3">
